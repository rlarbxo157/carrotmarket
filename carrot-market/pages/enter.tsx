      ...
      <div className="mt-8">
          ...
          <div className="mt-1">
            ...
            {method === "phone" ? (
              <div className="flex rounded-md shadow-sm">
                <span className="flex items-center justify-center px-3 rounded-l-md border border-r-0 border-gray-50 text-sm text-gray-500 select-none">+82</span>
        ...
        <div className="mt-8">
          <div className="relative">
            <div className="absoult w-full border-t border-gray-300 " />
            <div className="relative -top-3 text-center ">
              <span className="bg-white px-2 text-sm text-gray-500">Or enter with</span>
            </div>
          </div>
          <div className="grid grid-cols-2 mt-6 gap-3">
            <button className="flex justify-center item-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">
              <svg
                className="w-5 h-5"
                aria-hidden="true"
                fill="currentColor"
